...
# Smells in the exercise

* Uncommunicative name
    * Rename field / method etc.

* Long Method
    * Extract Method
    
* Indecent exposure
    * Fields with default visibility
    
* Conditional complexity
    * //TODO continue here....tomorrow
    
* Primitive Obsession
    * Plenty of examples - places, purses etc.
...
# Techniques for the exercises

* Automatic / IDE refactors only (may not be supported in all languages)

# Exercises N.B.

* Not an exhaustive list of smells and refactors - rules of thumb / guide-lines / heuristics
* Not important to learn the names - take what's useful

---

# Reading list / prep / follow-on tasks

Working Effectively With Legacy Code

Code reviews https://youtu.be/hfrNmZIPq3E
